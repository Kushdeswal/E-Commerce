                ...
                <div class="w-full flex-1 mt-8 ">
                    ...
                    <div class="my-7 border-b text-center ">
                        <div
                            ...
                            Enter otp send to e-mail address
                        </div>
                    </div>
                    ...
                    <div class="mx-auto max-w-xs">
                        ...
                        <h3 className='leading-none inline-block text-sm text-red-500 tracking-wide font-medium  transform translate-y-1/2 ml-[110px] mt-2 hover:text-red-600 hover:border-b hover:border-red-600 hover:border-dotted'
                            >Resend Otp?</h3>
                     
                        <h3 className='leading-none inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2  mt-3'>Already to Cartesian? <span className='text-green-500 hover:text-green-700'
                        onClick={() => navigate("/")}
                        > Sign In now.</span></h3>
