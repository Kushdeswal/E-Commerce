                ...
                <div class="w-full flex-1 mt-8 ">
                    ...
                    <div class="my-7 border-b text-center ">
                        <div
                            ...
                            Or sign in with Cartesian E-mail & User-id
                        </div>
                    </div>
                    ...
                    <div class="mx-auto max-w-xs">
                        <input
                            ...
                            type="email" placeholder="E-mail & User-id" />
                        <input
                        ...
                        <h3 className='leading-none inline-block text-sm text-gray-700 tracking-wide font-medium bg-white transform translate-y-1/2 ml-[102px] mt-2 hover:text-gray-600 hover:border-b hover:border-gray-600 hover:border-dotted'
                        onClick={() => navigate("/verify")}
                        >Forgot password?</h3>

                        <h3 className='leading-none inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2  mt-3'>New to Cartesian? <span className='text-green-500 hover:text-green-700'
