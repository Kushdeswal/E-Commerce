...
const Register = () => {
  ...
  <body className="dark:bg-slate-900 bg-gray-100 flex h-full items-center py-0">
        ...
        <div className="p-4 sm:p-7">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <a className="text-blue-600 decoration-2 hover:underline font-medium" onClick={login}>
                Sign in here
              </a>
            </p>
          </div>
          ...
          {/* =====User id */}
          <div>
                  <label for="id" className="block text-sm mb-2 dark:text-white">User Id</label>
                  <div className="relative">
                    <input type="text" id="user" name="user" autoFocus 
                    className="py-3 px-4 block w-full border-black-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="email-error"/>
              ...
              {/* email======= */}
                <div>
                  ...
                  <div className="relative">
                    <input type="email" id="email" name="email"  className="py-3 px-4 block w-full border-black-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="email-error"/>
                    <div className="hidden absolute inset-y-0 right-0  items-center pointer-events-none pr-3">
                      <svg className="h-5 w-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                      </svg>
