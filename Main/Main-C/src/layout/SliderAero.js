...
const SliderAero = () => {
  ...
  return (
    <div className=" sm:mt-2 mt-2 flex justify-center z-0   ">
   <div className=" w-5/6  ">
        <div className=" rounded-3xl mt-12 shadow-2xl  ">
            <div className=" text-3xl font-semibold  text-purple-800 hover:text-purple-600 ml-4 ">
              <h1 className="pt-3">aeroroamers</h1>
            </div>
            <div className="z-0">
              <Carousel responsive={responsive}  autoPlay={true} ssr={true}  autoPlaySpeed={6000} >
              {/* card===1 */} 
