...
const SliderMarvell = () => {
  ...
  return (
    <div className=" sm:mt-2 mt-2 flex justify-center   ">
      <div className=" w-5/6  ">
        <div className=" rounded-3xl mt-12 shadow-2xl  ">
            <div className=" text-3xl font-semibold  text-purple-800 hover:text-purple-600 ml-4 ">
              <h1 className="pt-3">marvellous</h1>
            </div>
            <div className="">
              <Carousel responsive={responsive}  autoPlay={true} ssr={true}  autoPlaySpeed={5000} >
              {/* card===1 */} 
